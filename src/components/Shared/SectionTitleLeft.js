  ...
  render() {
    return (
      <React.Fragment>
        ...
        <p className="text-muted">You can combine all the <span className="text-primary fw-bold"><span className="text-primary fw-bold">Dime.Scheduler</span></span>{" "} {this.props.desc} </p>
        <ul
